<template>
	<view class="container">
		...
		<view class="text"><u-textarea v-model="value" :cursorSpacing="100" :height="111" :maxlength="50"
				placeholder="请输入内容" count></u-textarea></view>
		<view class="div" style="margin-top: 44rpx;">
			<view class="div-l"></view>
			兴趣爱好
		</view>
		<view class="text"><u-textarea v-model="value1" :cursorSpacing="100" :maxlength="50" :height="111"
				placeholder="请输入内容" count></u-textarea></view>
		<view class="div" style="margin-top: 44rpx;">
			<view class="div-l"></view>
			心仪的TA
		</view>
		<view class="text"><u-textarea v-model="value2" :cursorSpacing="100" :maxlength="50" :height="111"
				placeholder="请输入内容" count></u-textarea></view>
